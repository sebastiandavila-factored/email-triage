...
from email_triage.schemas import GmailStatusResponse, InboxItem, SyncResponse, TriageRequest
...
@router.post("/sync")
async def sync(ctx: WriteTriageDep, settings: SettingsDep) -> SyncResponse:
        ...
        try:
            async with httpx.AsyncClient() as http:
                ...
                messages = await gmail.list_today(
                    http, access_token, TODAY_QUERY, settings.gmail_sync_max_results
                )
